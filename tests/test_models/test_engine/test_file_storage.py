...
class TestFileStorage_methods(unittest.TestCase):
    ...
    def test_new(self):
        ...
        self.assertIn("User." + usr.id, models.dataStorage.all().keys())
        self.assertIn(usr, models.dataStorage.all().values())
        self.assertIn("State." + st.id, models.dataStorage.all().keys())
        self.assertIn(st, models.dataStorage.all().values())
        self.assertIn("Place." + plc.id, models.dataStorage.all().keys())
        self.assertIn(plc, models.dataStorage.all().values())
