...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_new_instance_stored_in_objects(self):
        self.assertIn(User(), models.dataStorage.all().values())
...
class TestUser_save(unittest.TestCase):
    """Unittests for testing save method for User subclass"""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method of the subclass User class."""
    ...
    def test_to_dict_contains_added_attributes(self):
        usr = User()
        usr.middle_name = "Betty"
        usr.my_number = 98
        self.assertEqual("Betty", usr.middle_name)
